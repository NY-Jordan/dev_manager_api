...
class ProjectInvitationAcceptedNotification extends Notification
{
    use Queueable;
    ...
    {
        $notification =  ModelsNotification::createNotification(NotificationEnum::INVITATION_ACCEPTED, $this->user->id, $this->invitation->uuid);
